...
for i in range(len(labels)):
    flattened_images.append(np.reshape(images[i],[784,1]))
    vector=np.zeros(10)
    vector[labels[i]]=1
    vector_labels.append(vector)

print(vector_labels[0])
...
model.add(Dense(100, input_shape=(28*28,1), kernel_initializer='he_normal')) # first layer
